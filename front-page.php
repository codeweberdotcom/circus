    ...
    <?php
      ...
      ?>
        ...
        <script>
          ...
          let currentX = 0,
            currentY = 0;
          const speed = 0.1; // скорость следования (меньше значение — плавнее)
          ...
          // Функция для плавного следования
          function animate() {
            // Вычисляем плавное движение от текущей позиции к позиции курсора
